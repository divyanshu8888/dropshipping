                  ...
                  <div className="flex flex-col space-y-3">
                    ...
                    <div className="flex space-x-3">
                      <Link
                        ...
                        className="flex-1 px-4 py-2 border border-indigo-600 text-indigo-600 rounded-lg font-semibold hover:bg-indigo-50 transition-all text-center"
                      >
                        View Details
                      </Link>
                      <button
                        onClick={() => setShowQuoteForm(true)}
                        className="flex-1 px-4 py-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-lg font-semibold hover:from-indigo-700 hover:to-purple-700 transition-all shadow-md hover:shadow-lg"
                      >
                        Get Quote
                      </button>
                    </div>

...
const HomePage = ({ testimonials, stats }: HomePageProps) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-cyan-50 to-blue-50 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20">
          <div className="text-center animate-fade-in">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-6 justify-center">
              <Link
                href="/signup"
                className="group inline-flex items-center px-8 py-4 bg-gradient-to-br from-accent-blue via-accent-violet to-accent-cyan text-white rounded-xl text-lg font-semibold shadow-metallic hover:shadow-xl transition-all duration-300 hover:scale-105"
              >
              ...
              <Link
                href="/freelancers"
                className="group inline-flex items-center px-8 py-4 border-2 border-white/20 text-text-base rounded-xl text-lg font-semibold hover:bg-white/5 hover:border-white/40 transition-all duration-300 backdrop-blur-sm"
              >
            ...
            <div className="mt-8 text-sm text-text-mute">
      ...
      <section className="py-20 bg-bg-surface/60 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              { label: 'Active Freelancers', value: `${stats.totalFreelancers}+`, icon: '👥', color: 'from-accent-blue to-accent-violet' },
              { label: 'Projects Completed', value: `${stats.totalProjects.toLocaleString()}+`, icon: '✨', color: 'from-accent-violet to-accent-cyan' },
              { label: 'Happy Clients', value: `${stats.totalReviews.toLocaleString()}+`, icon: '😊', color: 'from-accent-cyan to-accent-blue' },
              { label: 'Countries', value: `${stats.countries}+`, icon: '🌍', color: 'from-accent-blue to-accent-violet' },
            ].map((stat, index) => (
              <div key={index} className="relative text-center p-8 rounded-2xl bg-bg-surface shadow-card border border-white/5 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                ...
                <div className="relative w-16 h-16 mx-auto mb-4 bg-gradient-to-r from-accent-blue/20 to-accent-violet/20 rounded-xl flex items-center justify-center">
      ...
      <section className="py-20 bg-bg-base">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-base text-accent-blue font-semibold tracking-wide uppercase mb-3">Why Choose Us</h2>
            <p className="mt-2 text-4xl md:text-5xl font-bold text-text-base leading-tight">
              Everything you need to <span className="text-accent-cyan">succeed</span>
            </p>
          </div>

...
const RequestQuotePage = () => {
  ...
  return (
    <div className="min-h-screen bg-bg-base">
      <Head>
        <title>Request a Quote — Unitiv</title>
        <meta
          name="description"
          content="Tell us about your project and we’ll match you with a verified Unitiv operator."
        />
      </Head>
      <Header />
      <main className="px-4 sm:px-6 lg:px-8 pt-24 pb-16 flex flex-col items-center gap-10">
        <section className="w-full max-w-4xl text-center space-y-4">
          <p className="text-xs uppercase tracking-[0.4em] text-white/60">Unitiv request desk</p>
          <h1 className="text-4xl sm:text-5xl font-semibold text-white tracking-tight">
            Request a Quote
          </h1>
          <p className="text-lg text-white/80">
            Tell us about your project and we’ll match you with a verified Unitiv operator.
          </p>
        </section>
